...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    # Can be removed when 2.9.13 is released.
    # Fixes an issue with the html-sanitizer python package:
    # https://github.com/matthiask/html-sanitizer/issues/20
    (fetchpatch {
      url = "https://gitlab.gnome.org/GNOME/libxml2/-/commit/85b1792e37b131e7a51af98a37f92472e8de5f3f.patch";
      sha256 = "sha256-epqlNs2S0Zczox3KyCB6R2aJKh87lXydlZ0x6tLHweE=";
    })
  ];
