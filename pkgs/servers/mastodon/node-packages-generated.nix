...
let
  sources = {
    ...
    "@babel/plugin-proposal-decorators-7.2.3" = {
      ...
      version = "7.2.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@babel/plugin-proposal-decorators/-/plugin-proposal-decorators-7.2.3.tgz";
        sha512 = "jhCFm7ftmue02EWIYqbhzP0iConEPsgVQeDriOs/Qc2lgr6MDtHTTrv3hE2GOOQDFjQ9tjP7nWQq0ad0JhIsQg==";
      };
    };
    ...
    "babel-plugin-macros-2.4.3" = {
      ...
      version = "2.4.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/babel-plugin-macros/-/babel-plugin-macros-2.4.3.tgz";
        sha512 = "M8cE1Rx0zgfKYBWAS+T6ZVCLGuTKdBI5Rn3fu9q6iVdH0UjaXdmF501/VEYn7kLHCgguhGNk5JBzOn64e2xDEA==";
      };
    };
    ...
    "browserslist-4.3.6" = {
      ...
      version = "4.3.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/browserslist/-/browserslist-4.3.6.tgz";
        sha512 = "kMGKs4BTzRWviZ8yru18xBpx+CyHG9eqgRbj9XbE3IMgtczf4aiA0Y1YCpVdvUieKGZ03kolSPXqTcscBCb9qw==";
      };
    };
    "buffer-4.9.1" = {
      name = "buffer";
    ...
    "electron-to-chromium-1.3.96" = {
      ...
      version = "1.3.96";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.96.tgz";
        sha512 = "ZUXBUyGLeoJxp4Nt6G/GjBRLnyz8IKQGexZ2ndWaoegThgMGFO1tdDYID5gBV32/1S83osjJHyfzvanE/8HY4Q==";
      };
    };
    "elliptic-6.4.1" = {
      name = "elliptic";
    ...
    "node-releases-1.1.2" = {
      ...
      version = "1.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/node-releases/-/node-releases-1.1.2.tgz";
        sha512 = "j1gEV/zX821yxdWp/1vBMN0pSUjuH9oGUdLCb4PfUko6ZW7KdRs3Z+QGGwDUhYtSpQvdVVyLd2V0YvLsmdg5jQ==";
      };
    };
    "node-sass-4.11.0" = {
      name = "node-sass";
    ...
    "postcss-7.0.7" = {
      ...
      version = "7.0.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/postcss/-/postcss-7.0.7.tgz";
        sha512 = "HThWSJEPkupqew2fnuQMEI2YcTj/8gMV3n80cMdJsKxfIh5tHf7nM5JigNX6LxVMqo6zkgQNAI88hyFvBk41Pg==";
      };
    };
    ...
    "react-transition-group-2.5.2" = {
      ...
      version = "2.5.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/react-transition-group/-/react-transition-group-2.5.2.tgz";
        sha512 = "vwHP++S+f6KL7rg8V1mfs62+MBKtbMeZDR8KiNmD7v98Gs3UPGsDZDahPJH2PVprFW5YHJfh6cbNim3zPndaSQ==";
      };
    };
    "read-cache-1.0.0" = {
      name = "read-cache";
    ...
    "terser-webpack-plugin-1.2.0" = {
      ...
      version = "1.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/terser-webpack-plugin/-/terser-webpack-plugin-1.2.0.tgz";
        sha512 = "QW7RACLS89RalHtLDb0s8+Iqcs/IAEw1rnVrV+mS7Gx1kgPG8o1g33JhAGDgc/CQ84hLsTW5WrAMdVysh692yg==";
      };
    };
    "throng-4.0.0" = {
      name = "throng";
  ...
  args = rec{
    ...
    dependencies = [
      ...
      sources."@babel/plugin-proposal-decorators-7.2.3"
      ...
      sources."babel-plugin-macros-2.4.3"
      ...
      sources."ejs-2.6.1"
      sources."electron-to-chromium-1.3.96"
      ...
      sources."react-transition-group-2.5.2"
      ...
      (sources."terser-webpack-plugin-1.2.0" // {
        dependencies = [
          sources."find-cache-dir-2.0.0"
          sources."find-up-3.0.0"
          sources."locate-path-3.0.0"
