...
let
  sources = {
    ...
    "babel-plugin-macros-2.1.0" = {
      ...
      version = "2.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/babel-plugin-macros/-/babel-plugin-macros-2.1.0.tgz";
        sha512 = "0a33n44pvfcl7lcya8m4rdivpcqqfcn6yf9yay4bhdc98y79b3dk120qbll4lwz4qkvm33ax9x2bfl764nd5q27110j3mi3szf5kb52";
      };
    };
    ...
    "babel-plugin-react-intl-2.4.0" = {
      ...
      version = "2.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/babel-plugin-react-intl/-/babel-plugin-react-intl-2.4.0.tgz";
        sha512 = "1f8kprarywkrgz71cs3m7dkzmyfmssqijm2xl8ydi3i9rg07jyxgc1n1fss5ibspcsik52f9hdl3mxpjfmix2aq1kni6av90wwygbmg";
      };
    };
    ...
    "bfj-node4-5.2.0" = {
      ...
      version = "5.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/bfj-node4/-/bfj-node4-5.2.0.tgz";
        sha512 = "367fx567si1xhz5lal7y8ybi23j320xr06921y1gs1pc3y77rfln34n8wpqll9i619n5x4mriqf5jxijgg4gz4lri06kmpbnpm005mj";
      };
    };
    "big.js-3.2.0" = {
      name = "big.js";
    ...
    "caniuse-lite-1.0.30000802" = {
      ...
      version = "1.0.30000802";
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30000802.tgz";
        sha512 = "0dp0qmzbgh7lj22m3715j1cxmcw3kxgg81mqpjk5mi3m9z1qh39rqyycz6ynb6mvg87p20vb7fvi3n3jbc05z0y39qvzm7mpbwk16ls";
      };
    };
    "caseless-0.11.0" = {
      name = "caseless";
    ...
    "compression-webpack-plugin-1.1.6" = {
      ...
      version = "1.1.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/compression-webpack-plugin/-/compression-webpack-plugin-1.1.6.tgz";
        sha512 = "0bfgzh3xy179p0c309vpsi6bqx6rm01xrhgsv3dqvwf1g59cfkiqvypsr353a6xn4ykri39mpnfxg4vl0q94nndxw1289mm83gaimm0";
      };
    };
    "concat-map-0.0.1" = {
      name = "concat-map";
    ...
    "webpack-bundle-analyzer-2.10.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "012ylfsl929anmz35mrb2mclxwimmrbm98d5d5b7s6sbp135dr4s8nydsjinh3afs2jggswf8ksbdqmqzkskn12gibma5jbyqbzs3vq";
      };
    };
    ...
    dependencies = [
      ...
      (sources."autoprefixer-7.2.5" // {
        dependencies = [
          ...
          sources."caniuse-lite-1.0.30000802"
      ...
      (sources."babel-plugin-preval-1.6.3" // {
        dependencies = [
          (sources."babel-plugin-macros-2.1.0" // {
            dependencies = [
      ...
      (sources."babel-plugin-react-intl-2.4.0" // {
        dependencies = [
          (sources."babel-runtime-6.26.0" // {
            dependencies = [
              sources."core-js-2.5.3"
      ...
      (sources."compression-webpack-plugin-1.1.6" // {
        dependencies = [
          sources."async-2.6.0"
      ...
      (sources."webpack-bundle-analyzer-2.10.0" // {
        dependencies = [
          sources."acorn-5.4.1"
          (sources."bfj-node4-5.2.0" // {
            dependencies = [
              sources."bluebird-3.5.1"
