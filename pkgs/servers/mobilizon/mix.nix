  ...
  packages = with beamPackages; with self; {
    ...
    cldr_utils = buildMix rec {
      ...
      src = fetchHex {
        pkg = "${name}";
        version = "${version}";
        sha256 = "0mynxrp7ilxwvarw43f5981cqlpqxgkypfj9bnddbzw9makfh57a";
      };
    ...
    ex_cldr_dates_times = buildMix rec {
      ...
      src = fetchHex {
        pkg = "${name}";
        version = "${version}";
        sha256 = "033km8n5qpmsrvcfvwvxqmfv5lqhrlj5amhgiznvfsicchsr1m5k";
      };
    ...
    oban = buildMix rec {
      ...
      src = fetchHex {
        pkg = "${name}";
        version = "${version}";
        sha256 = "16r1q2pqq0fhn5n997lvjm6kl15k7jkdz2bfg90scykw6x1king5";
      };
